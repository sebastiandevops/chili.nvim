...
local function get_custom_highlights(data)
  local d = data ---@module 'chili.palette-dark'
...
---@param theme chili.HighlightDef
...
local function get_highlights(data, custom)
  ...
  return {
    ...
    ['IncSearch'] = { bg = t.codelens_fg, underline = true },
    ['Substitute'] = { bg = t.codelens_fg },
    ...
    ['@constructor'] = { fg = p.syntax.lavender, bg = p.syntax.reference, bold = true },
    ['@type'] = { link = 'Type' },
    ...
    ['@keyword.function'] = { fg = p.syntax.green, bg = 'NONE', italic = true },
    ['@function'] = { link = 'Function' },
    ...
    ['@punctuation.bracket'] = { fg = p.ansi.bright.blue, bg = 'NONE' },
    ...
    ['@variable.builtin'] = { fg = p.syntax.turquoise },
    ...
    ['@namespace.builtin'] = { fg = p.syntax.turquoise },
    ['@symbol'] = { fg = t.fg },
    ...
    ['@lsp.type.parameter.dockerfile'] = { fg = p.syntax.purple_soft },
...
---@param plugins {[string]: chili.Opts}
---@param highlights {[string]: chili.Opts}
...
function M.set_highlights(config)
  ...
  local data = require(('chili.palette-%s'):format(bg)) ---@module 'chili.palette-dark'
